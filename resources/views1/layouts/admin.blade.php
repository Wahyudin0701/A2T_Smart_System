    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex flex-column align-items-center justify-content-center my-3" href="{{ url('/home') }}">
                ...
                <div class="sidebar-brand-text m-1">Admin Robust</div>
            </a>
            ...
            <li class="nav-item {{ Nav::isRoute('absen-member') }}">
                <a class="nav-link" href="{{ route('absen-member') }}">
            ...
            <li class="nav-item {{ Nav::isRoute('data-members') }}">
                <a class="nav-link" href="{{ route('data-members') }}">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <div class="d-flex align-items-center mr-2">
                            <a href="{{ route('scan-qr') }}" class="btn btn-danger btn-lg-2">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Maintained by Robust Smart System. {{ now()->year }}</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
